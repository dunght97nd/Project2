...
import tmdbApi, { category, personType } from '../../api/tmdbApi';

const CastGrid = props => {
    ...
    useEffect(() => {
        const getList = async () => {
            ...
            if (keyword === undefined) {
                const params = {};
                if (props.category === category.person) {
                    //Get data people
    ...
    return (
        <>
            ...
            <div className="cast-grid">
                {
                    items.map((item, i) => <CastCard category={props.category} item={item} key={i} />)
                }
            </div>
            {
                page < totalPage ? (
                    <div className="cast-grid__loadmore">
